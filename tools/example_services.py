...
SERVICES = [
    ...
    # --- LAB-B ---
    O("OUT-08", "LAB-B", 200, 0, 105, "DB3-C01", 4, notes="above the prep bench"),
    O("OUT-09", "LAB-B", 560, 0, 105, "DB3-C02", 4, notes="UPS-backed, above the LC-MS"),
    ...
    S("STRIP-02", "strip", "LAB-B", 50, 10, 0, parent="BENCH-11.A", fed_by="OUT-09", sockets=6,
      socket_type="standard", notes="under the LC-MS bench"),
    ...
    S("STRIP-04", "strip", "LAB-B", 120, 10, 0, parent="BENCH-13.A", fed_by="OUT-11", sockets=6,
      socket_type="standard", notes="under the GC bench"),
...
CIRCUITS = [
    ...
    C("DB3-C01", notes="prep bench and island"),
    C("DB3-C02", "ups", "LC-MS, on the building UPS"),
    C("DB3-C03", notes="right-hand bench spine"),
    C("DB3-C04", notes="GC bench"),
...
LINKS = [
    ...
    L("PC-02", "HPLC-01", "ethernet"),
    L("PC-02", "MS-01", "ethernet"),
    L("PC-02", "MON-02", "video"),
    L("PUMP-02", "MS-01", "other", 300, "vacuum hose"),
    L("N2G-01", "MS-01", "gas-line", 1500),
    L("N2G-01", "EVAP-01", "gas-line", 1500),
    L("PC-03", "GC-01", "ethernet"),
    L("PC-03", "MON-03", "video"),
    L("GAS-03", "GC-01", "gas-line", 1000, "carrier gas"),
    L("GAS-04", "GC-01", "gas-line", 1000, "FID fuel"),
